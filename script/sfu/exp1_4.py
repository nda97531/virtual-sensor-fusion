...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', '-n', default='exp1_4_bin',
    ...
    for _ in range(NUM_REPEAT):
        ...
        flow = VSFFlow(
            ...
            callbacks=[
                ...
                ReduceLROnPlateau(optimizer=cls_optimizer, mode='max', patience=LR_SCHEDULER_PATIENCE, verbose=True),
                # ReduceLROnPlateau(optimizer=contrast_optimizer, mode='max', patience=LR_SCHEDULER_PATIENCE,
                #                   verbose=True)
            ],
