...
Sensor fusion: wrist accelerometer + belt accelerometer
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', '-n', default='test1_4_wrist_belt',
    ...
    for _ in range(NUM_REPEAT):
        ...
        head = OneSetDistributor(
            ...
            num_classes={
                ...
                'belt_acc': len(train_dict[list(train_dict.keys())[0]])
            },
